    ...
    $.fn.expand = function () {
        return this.each(function () {
            ...
            childrenOf($(this)).each(function () {
                ...
                if ($.inArray(this, expandedNodes) > -1) {
                    $(this).expand();
                    expandedNodes = jQuery.grep(expandedNodes, function (value) {
                        return value != this;
                    });
                }
        ...
        if (!node.hasClass("initialized")) {
            ...
            if (node.hasClass("parent")) {
                ...
                if (options.expandable) {
                    ...
                    var newLink;
                    var parent = parentOf(node);
                    var childNodesOfParent = new Array();
                    if (parent != null) {
                        childNodesOfParent = childrenOf(parent);
                    }
					/* added */
					options.indent = 10;
                    if (childNodesOfParent.length > 0 && node[0] != childNodesOfParent[childNodesOfParent.length - 1]) {
                        newLink = '<a href="#" title="' + options.stringExpand + '" style="cursor:default; margin-left: -' + options.indent + 'px; padding-left: ' + options.indent + 'px" class="expander"></a>';
                    }
                    else {
                        newLink = '<a href="#" title="' + options.stringExpand + '" style="cursor:default; margin-left: -' + options.indent + 'px; padding-left: ' + options.indent + 'px" class="expander-last"></a>';
                    }
                    ...
                    $(node).click(function () { node.toggleBranch(); return false; }).mousedown(function () { return false; });
                    $(node).keydown(function (e) { if (e.keyCode == 13) { node.toggleBranch(); return false; } });
                ...
                if (childNodesOfParent.length > 0 && node[0] != childNodesOfParent[childNodesOfParent.length - 1]) {
                    newLink = '<a href="#" title="' + options.stringExpand + '" style="cursor:default; margin-left: -' + options.indent + 'px; padding-left: ' + options.indent + 'px" class="item"></a>';
                }
                else {
                    newLink = '<a href="#" title="' + options.stringExpand + '" style="cursor:default; margin-left: -' + options.indent + 'px; padding-left: ' + options.indent + 'px" class="item-last"></a>';
                }
