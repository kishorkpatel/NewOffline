...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:output method="html"/>
	...
	<xsl:param name="br"></xsl:param>
	<xsl:param name="epic"></xsl:param>
	<xsl:param name="story"></xsl:param>
      ...
      <div id="logodate">
        ...
        <div id="summary">
          <table style="text-align: left; margin-right: 10px;width:100%">
            <tr>
              <td class="attrname">Epic</td>
              <td>:</td>
              <td><span><xsl:value-of disable-output-escaping="yes" select="$epic"/></span></td>
              <td class="attrname">Story</td>
              <td>:</td>
              <td><span><xsl:value-of disable-output-escaping="yes" select="$story"/></span></td>
              <td class="attrname">Acceptance Criteria</td>
              <td>:</td>
              <td><span><xsl:value-of disable-output-escaping="yes" select="$br"/></span></td>
            </tr>
            <tr>              
            </tr>
            <tr>
				<td class="attrname">Test Case Name</td>
				<td>:</td>
  ...
  <xsl:template name="TCIterationTemplate">
    ...
    <xsl:for-each select="Task">
      <xsl:choose>
        ...
        <xsl:when test="@IsSystemTask='true' and @ParentID=''">
        ...
        <xsl:when test="@ParentID='' and @taskType!='A' and @IsSystemTask='false'">
...
<xsl:variable name="parentId">
  ...
  <xsl:template name="TaskTemplate">
    ...
    <xsl:param name="logId"></xsl:param>
    <xsl:param name="imageId"></xsl:param>
	<xsl:param name="ParamTaskSeq" select="."></xsl:param>
